...
export function GraphToolbar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2">
      {/* Search ------------------------------------------------------------ */}
      {/* `min-w-[200px]` was 55% of a 360px screen and forced the rest of the
          toolbar off the row; below `sm` the field simply takes the full width. */}
      <label className="relative flex w-full min-w-0 flex-1 items-center sm:min-w-[200px]">
      ...
      <details className="relative">
        ...
        <div className="absolute left-0 z-20 mt-1 w-[calc(100vw-2rem)] max-w-[14rem] rounded-lg border border-slate-200 bg-white p-2 shadow-lg sm:w-56">
