  ...
  return (
    <section className="relative overflow-hidden">
      <div className="relative min-h-[100svh] overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,.94)_0%,rgba(255,255,255,.68)_38%,transparent_72%)]" />
        ...
        <div className="relative mx-auto flex min-h-[calc(100svh-82px)] max-w-[1100px] flex-col justify-center px-6 pb-20 text-center md:px-10">
          ...
          <Reveal index={2}>
            <p className="mx-auto mb-[36px] max-w-[660px] text-[19px] leading-[1.6] text-[#4f5f58]">
              {t("hero.subhead")}
