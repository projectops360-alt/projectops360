  ...
  return (
    <section className="relative overflow-hidden">
      <div className="relative min-h-[100svh] overflow-hidden">
        ...
        />
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,.32)_0%,rgba(255,255,255,.58)_62%,#f7f8f4_100%)]" />
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,.92)_0%,rgba(255,255,255,.62)_36%,transparent_68%)]" />

        <LandingNav />

        <div className="relative mx-auto flex min-h-[calc(100svh-82px)] max-w-[1100px] flex-col justify-center px-6 pb-20 text-center md:px-10">
          <Reveal index={0} className="mb-[30px] inline-flex self-center items-center gap-[9px] rounded-full border border-[#c8ead8] bg-white/80 px-4 py-2 text-[12.5px] font-extrabold uppercase tracking-[.1em] text-[#064e3b] shadow-sm backdrop-blur-md">
            <span className="lp-anim-dot h-[7px] w-[7px] rounded-full bg-[#007a4d]" />
            {t("hero.badge")}
          </Reveal>

          <Reveal index={1}>
            <h1 className="lp-display m-0 mb-7 text-[clamp(48px,8vw,92px)] font-extrabold leading-[0.94] tracking-[-.05em] text-[#07130f] [text-wrap:balance]">
              {t("hero.title1")}
              <br />
              <span className="lp-grad-text">{t("hero.title2")}</span>
            </h1>
          </Reveal>

          <Reveal index={2}>
            <p className="mx-auto mb-[36px] max-w-[660px] text-[19px] leading-[1.6] text-[#4f5f58] [text-wrap:balance]">
              {t("hero.subhead")}
