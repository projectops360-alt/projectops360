...
import { getOrgContext, getProjectAccess, canManageProjectMembers } from "@/lib/auth";
...
async function ctx(projectId: string) {
  ...
  return { org, access, supabase: createAdminClient(), canManage: canManageProjectMembers(access) };
}
