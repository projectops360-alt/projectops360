...
export const UX_013_WORKBOARD_RESPONSIVE: ProductUxContract = {
  ...
  rules: [
    ...
    "The board is ONE 2D scroll area height-bounded to the viewport: it scrolls BOTH ways on the same container — the vertical scrollbar (right) goes down through tall columns, the horizontal scrollbar (bottom) moves across columns. Both bars stay pinned to the board's edges (in view), never at the bottom of a long column.",
