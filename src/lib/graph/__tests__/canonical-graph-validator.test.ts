...
const object = { id: "33333333-3333-4333-8333-333333333333", organizationId: org, scope: "project" as const, projectId: project, ownerUserId: null, knowledgeType: "finding", status: "active", currentVersionNo: 1, activeVersionNo: 1, title: "Finding", summary: "Summary", body: "Body", structuredContent: {}, confidence: "high", confidenceReason: "Evidence", provenance: { captureMethod: "direct", sourceKind: "review", sourceRef: "review-1" }, evidenceCount: 1, createdBy: "44444444-4444-4444-8444-444444444444", createdAt: "2026-01-01T00:00:00Z", updatedAt: "2026-01-01T00:00:00Z" } satisfies KnowledgeObjectReadModel;
