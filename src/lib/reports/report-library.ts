...
export const PREBUILT_REPORTS: PrebuiltReport[] = [
  ...
  {
    id: "financial_control_summary",
    name: "Financial Control Summary",
    description: "PMO view of baseline, funding, commitment, cost exposure, cash flow, forecast, and control exceptions.",
    category: "budget",
    datasetId: "financial_control",
    config: {
      columns: [
        "project_name",
        "currency",
      ...
      filters: [],
      grouping: null,
      sort: [{ column: "project_name", direction: "asc" }],
      visualization: "table",
    },
  },
  {
