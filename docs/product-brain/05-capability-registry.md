...
| CAP-045 | Living Graph Process Mining Layer | P2/P4 | Partial (event capture — pilot flag OFF) | 10% | `lib/events` (risk pilot capture: registry types, writers, derived bridge, backfill, `project_event_objects`) — docs: [baseline](capabilities/CAP-045-process-mining-layer-foundation-baseline.md) · [ontology](capabilities/CAP-045-process-mining-layer-ontology-risk-to-resolution.md) · [platform map](capabilities/CAP-045-process-mining-layer-platform-map-and-validation.md) · [event contract & audit](capabilities/CAP-045-canonical-event-contract-and-source-audit.md) (all approved; P2-T2 implemented 2026-07-12, flag OFF in prod) |
