...
| CAP-046 | Project Intelligence Engine (Variants · Root Cause Miner · KPI Engine) | P2/P4 | Implemented (Phase 1) | 60% | `lib/process-mining`, `lib/kpi` ([CAP-046](capabilities/CAP-046-project-intelligence-engine.md), PD-019 — consumes the PEG, no second pipeline; F3 Phase 2 = persisted custom KPI definitions) |
