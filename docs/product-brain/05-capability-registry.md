...
| CAP-045 | Living Graph Process Mining Layer | P2/P4 | Partial (risk pilot + mining-ready task lifecycle; flags OFF) | 18% | `lib/events` (canonical registry/gateway, risk capture, semantic task/milestone/dependency capture, object-centric backfill, `project_event_objects`) + primary/bulk writers in Roadmap, Execution Map, Delivery, Import, Templates and Phase 0 sync — docs: [baseline](capabilities/CAP-045-process-mining-layer-foundation-baseline.md) · [ontology](capabilities/CAP-045-process-mining-layer-ontology-risk-to-resolution.md) · [platform map](capabilities/CAP-045-process-mining-layer-platform-map-and-validation.md) · [event contract & audit](capabilities/CAP-045-canonical-event-contract-and-source-audit.md) (approved contract; P2-T2 rebaseline 2026-07-13; rollout flags default OFF) |
