...
| [capabilities/CAP-045-process-mining-layer-platform-map-and-validation.md](capabilities/CAP-045-process-mining-layer-platform-map-and-validation.md) | **CAP-045 · Platform map & validation** — current vs target map (10 layers), vocabulary alignment, 3-case ontology validation (P1-T3 / PD-017; approval pending) |
