...
| Reports / Status Report | Pending | ~70% | — | CAP-024 | aligned semantics ([REG-008](10-regression-log.md)) · ↪ verify target in [REG-013](10-regression-log.md#reg-013) · ✅ [REG-015/UX-009](10-regression-log.md#reg-015) Status+Closeout on dashboard |
